...
export const components: Writable<ComponentContainer[]> = writable([
    {
        ...
        components: [
            ...
            },
            {
                type: 10,
                id: 3,
                content: "Photo by [Mathieu Bigard](https://unsplash.com/@mathieubigard) on [Unsplash](https://unsplash.com/photos/majestic-mountains-reflect-in-the-turquoise-lake-U1o2u8UrHLc)",
            },
            {
                type: 14, // Seperator
                id: 4,
            },
            {
                type: 10,
                id: 5,
                content: 'For more info on how to use components, check out the [documentation](https://discord.com/developers/docs/components/reference)'
            }
        ]
    }
]);